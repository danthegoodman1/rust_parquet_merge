...
pub use compaction::{
    ...
    ExecutionScratch, ParquetCompression, ParquetEncoding, ParquetMergeExecutionOptions,
    ParquetWriterColumnOptions, ParquetWriterVersion, UnorderedMergeOrder,
    build_compiled_payload_plan, compact_ndjson_to_parquet, discover_ndjson_schema_from_paths,
    merge_payload_parquet_files, merge_payload_parquet_files_with_execution,
    merge_top_level_parquet_files, merge_top_level_parquet_files_with_execution,
};
